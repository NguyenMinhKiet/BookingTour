...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20241105134347_createDb")]
            ...
            modelBuilder.Entity("Domain.Entities.Booking", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            booking_id = -1,
                            booking_date = new DateTime(2024, 11, 5, 20, 43, 47, 334, DateTimeKind.Local).AddTicks(4571),
                            customer_id = -1,
                            num_people = 2,
                        ...
                        {
                            booking_id = -2,
                            booking_date = new DateTime(2024, 11, 5, 20, 43, 47, 334, DateTimeKind.Local).AddTicks(4573),
                            customer_id = -2,
                            num_people = 1,
            ...
            modelBuilder.Entity("Domain.Entities.Payment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            payment_id = -1,
                            booking_id = -1,
                            payment_date = new DateTime(2024, 11, 5, 20, 43, 47, 334, DateTimeKind.Local).AddTicks(4588),
                        ...
                        new
                        {
                            payment_id = -2,
                            booking_id = -2,
                            payment_date = new DateTime(2024, 11, 5, 20, 43, 47, 334, DateTimeKind.Local).AddTicks(4590),
            ...
            modelBuilder.Entity("Domain.Entities.TourDestination", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            tour_id = -1,
                            destination_id = -1,
                            visit_date = new DateTime(2024, 11, 5, 20, 43, 47, 334, DateTimeKind.Local).AddTicks(4521)
                        },
                        new
                        {
                            tour_id = -2,
                            destination_id = -2,
                            visit_date = new DateTime(2024, 11, 5, 20, 43, 47, 334, DateTimeKind.Local).AddTicks(4530)
                        });
                });
