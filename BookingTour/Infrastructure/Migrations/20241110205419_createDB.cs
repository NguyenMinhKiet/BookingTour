        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Authorizeds_Accounts_AccountID",
                        column: x => x.AccountID,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Authorizeds_RoleGroups_GroupID",
                        column: x => x.GroupID,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalPrice = table.Column<decimal>(type: "decimal(10,2)", nullable: false, defaultValue: 0m),
                    CreateAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifyAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Authorizeds_AccountID",
                table: "Authorizeds",
                column: "AccountID",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Authorizeds_AccountID_GroupID",
                table: "Authorizeds",
                columns: new[] { "AccountID", "GroupID" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Authorizeds_GroupID",
                table: "Authorizeds",
                column: "GroupID",
                unique: true);
